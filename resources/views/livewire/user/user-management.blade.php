        ...
        <div
            ...
            <div class="my-auto ml-auto pr-6">
                <a href="{{ route('user-add') }}">
                    <button type="button"
                            class="inline-block px-8 py-2 m-0 text-xs font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer ease-soft-in leading-pro tracking-tight-soft bg-developer-purple-gradiant shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85">
                        🤩 Add User</button>
                </a>
                    ...
                    <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td
                                    ...
                                    <div class="flex px-4 py-1">
                                        <div class="flex flex-col justify-center">
                                            <img src="{{ $user->facebook_avatar ?:($user->google_avatar?:'../assets/img/avatarDefault.png') }}"
                                ...
                                <td
                                        class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <p class="mb-0 font-semibold leading-tight text-size-xs">{{$user->updated_at}}</p>
                                </td>
